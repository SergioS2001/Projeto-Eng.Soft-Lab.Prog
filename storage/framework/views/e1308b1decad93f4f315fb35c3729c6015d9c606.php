...
<tbody>
               <ul class="list-group">
                   ...
                   <li class="list-group-item">
<tr>
                       <h5 class="Subtitle"><td><?php echo e($edificio->id); ?> </td><td> <?php echo e($edificio->Nome); ?> </td><td> <?php echo e($edificio->Piso_min); ?></td><td> <?php echo e($edificio->Piso_max); ?></td><td> <?php echo e($edificio->Morada); ?></td><td><?php echo e($edificio->date_in); ?> </td><td><?php echo e($edificio->date_out); ?> </td><td>   <a href="/Edificio/Update/<?php echo e($edificio->id); ?>">Update</a></td><td>  <a href="/Edificio/Delete/<?php echo e($edificio->id); ?>" >Delete</a></td></h5>
</tr>
                    </li>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
